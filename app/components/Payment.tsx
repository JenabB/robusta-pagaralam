...
const Payment = () => {
    const payments = [
        ...
        { name: 'BSI', logo: "/images/BSI.png" }
    ];
    return (
        <div className='bg-teal-100 p-4 text-center lg:flex lg:justify-between items-center px-5' >
            <div>
            ...
            <div className='xs:mt-12 flex justify-center gap-10 items-center'>
